...
//Default direction. When the game starts, Snake goes right (like Nokia 3310 :))
	...
	public void keyPressed(KeyEvent e) {
    	...
    	switch( keyCode ) { 
      	  case KeyEvent.VK_UP: 		if (arrow[p].getValue() != Direction.DOWN)  //If you are going down you can't turn up, or you will die.
										arrow[p].setDirection(Direction.UP);
										break;
      	  case KeyEvent.VK_DOWN:	if (arrow[p].getValue() != Direction.UP)
										arrow[p].setDirection(Direction.DOWN);
        								break;
     	  case KeyEvent.VK_LEFT:	if (arrow[p].getValue() != Direction.RIGHT)
										arrow[p].setDirection(Direction.LEFT);           			
         							   	break;
          case KeyEvent.VK_RIGHT :	if (arrow[p].getValue() != Direction.LEFT)
