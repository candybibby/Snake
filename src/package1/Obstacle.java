...
public class Obstacle {
	...
	public void levelMedium(){
		...
		int y = (int)(Math.random()*Synchronizer.getGameAreaHeight() - 2);
	...
	public void levelHard(){
		...
		int y1 = (int)(Math.random()*Synchronizer.getGameAreaHeight() - 2);
		...
		int y2 = (int)(Math.random()*Synchronizer.getGameAreaHeight() - 2);
	...
	public void levelExpert(){
		...
		// three obstacles horizontal and two vertical
			...
			int y3 = (int)(Math.random()*Synchronizer.getGameAreaHeight() - 2);
